...
(function(){
  ...
  const prayerBindingLookup = getPrayerBindingLookup();
  ...
  const prayerState = ensurePrayerState(GameState);
  rebuildPrayerBindingLookup(prayerState);
  const monsterState = normalizeMonsterState(GameState.monster, GameState);
  ...
  function importGameState(json){
    ...
    try {
      ...
      normalizeMonsterState(monsterState, GameState);
